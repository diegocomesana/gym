# Circuito intermitente neuromuscular (CIN / circuito intermitente con sobrecargas)

## Qué es (idea general)

Es una **metodología híbrida** que mezcla:

1. **Entrenamiento en circuito** — varias estaciones seguidas, cada una con un ejercicio distinto (se repite el circuito una o más vueltas).  
2. **Trabajo intermitente** — en cada estación hay **tiempos definidos de esfuerzo y de descanso** (ratio trabajo:descanso), en lugar de “hacer series clásicas con descansos largos entre series del mismo ejercicio”.  
3. **Sobrecarga neuromuscular** — los ejercicios suelen ser de **fuerza/resistencia con carga** (mancuernas, bandas, peso corporal exigente, máquinas), de modo que el sistema **neuromuscular** (fuerza, coordinación, fatiga muscular) entra fuerte, no solo el “cardio suave”.

En la literatura en español a veces aparece como **circuito intermitente con sobrecargas** (énfasis en que no es solo movilidad o cardio ligero).

## Qué busca el método

- **Eficiencia de tiempo:** mucha densidad de trabajo en una sesión corta.  
